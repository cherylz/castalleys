...
import poweredByListenNotes from '../css/images/powered-by-listen-notes-logo.png';
  ...
  render() {
    return (
      <div>
        ...
        <footer style={{ marginBottom: this.props.hidePlayer ? '50px' : '130px' }}>
          <div className="main-footer">
            ...
            <a href="mailto:czcodes@gmail.com" className="shake" id="email" aria-label="email">
          ...
          <div>
            <img
              className="listen-notes"
              src={poweredByListenNotes}
